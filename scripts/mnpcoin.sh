...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mnpcoin.conf'
CONFIGFOLDER='/root/.mnpcoin'
COIN_DAEMON='mnpcoind'
COIN_CLI='mnpcoin-cli'
COIN_PATH='/usr/bin/'
COIN_TGZ='https://github.com/hoanghiep1x0/wallets/raw/master/mnpcoin/mnpcoin.zip'
COIN_FODER_UNZIP='mnpcoin'
