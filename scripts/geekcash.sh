...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='geekcash.conf'
CONFIGFOLDER='/root/.geekcash'
COIN_DAEMON='geekcashd'
COIN_CLI='geekcash-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/GeekCash/geekcash/releases/download/v1.0.1.3/geekcash-1.0.1-x86_64-linux-gnu.tar.gz'
COIN_FODER_UNZIP='./geekcash-1.0.1/bin'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='geekcash'
COIN_EXPLORER='https://explorer.geekcash.org'
COIN_PORT=6889
RPC_PORT=6888
...
function create_config() {
  ...
  rm -rf $CONFIGFOLDER/$CONFIG_FILE
